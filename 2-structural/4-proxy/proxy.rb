...
# You'll be able to pass it as a proxy instead of a real subject.
class Subject
    # @abstract
    def request
...
class Proxy < Subject
    ...
    def check_access
        puts 'Proxy: Checking access before firing a real request.'
        true
    end
  
    def log_access
        puts 'Proxy: Logging the time of the request.'
    end
end
  
# The client code is supposed to work with all objects (both subjects and
# proxies) via the Subject interface to support both real subjects and
