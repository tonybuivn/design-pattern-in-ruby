...
# managing its lifecycle. All of this shields the client from the undesired
...
# The Subsystem can accept requests either from the facade or the client directly.
